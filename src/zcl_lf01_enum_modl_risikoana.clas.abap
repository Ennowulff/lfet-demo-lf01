...
"! Diese Model-Klasse dient der Verwendung in ZCL_LF01_ENUM_RULE_RISIKOAN
...
CLASS zcl_lf01_enum_modl_risikoana DEFINITION
  PUBLIC
  CREATE PUBLIC.

  PUBLIC SECTION.
    INTERFACES zif_LF01_enum_risikoanalyse.

    ALIASES trace FOR zif_LF01_enum_risikoanalyse~trace.
  ...
  PROTECTED SECTION.
    ...
    DATA values TYPE zif_LF01_enum_risikoanalyse=>_values.
    "! <p class="shorttext synchronized" lang="en">Aktueller ermittelter Aktionswert</p>
    DATA state  TYPE zif_LF01_enum_risikoanalyse=>_state.
...
CLASS zcl_lf01_enum_modl_risikoana IMPLEMENTATION.
  METHOD constructor.
    trace = NEW /rbgrp/cl_trace( ).
  ENDMETHOD.

  METHOD zif_LF01_enum_risikoanalyse~is_projektumfang.
  ...
  METHOD zif_LF01_enum_risikoanalyse~is_rechtl_rahmenbedingungen.
  ...
  METHOD zif_LF01_enum_risikoanalyse~is_ressourcen_abhaengigkeit.
  ...
  METHOD zif_LF01_enum_risikoanalyse~set_projektumfang.
    values-projektumfang = i_value.
  ENDMETHOD.

  METHOD zif_LF01_enum_risikoanalyse~set_rechtl_rahmenbedingungen.
    values-rechtl_rahmenbedingung = i_value.
  ENDMETHOD.

  METHOD zif_LF01_enum_risikoanalyse~set_ressourcen_abhaengigkeit.
    values-ressourcen_abhaengigkeit = i_value.
  ENDMETHOD.

  METHOD zif_LF01_enum_risikoanalyse~do_risikoanalyse.
    state-risikoanalyse = i_value.
  ENDMETHOD.

  METHOD zif_LF01_enum_risikoanalyse~get_risikoanalyse.
